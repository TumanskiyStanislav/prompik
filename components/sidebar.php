    ...
    <nav class="sidebar_navigation">
        <section class="nav_logo_and_links">
            ...
            <ul class="nav_logo_and_links_list">
                <li>
                    <a href="/catalog" class="nav_logo_and_links_list_link">
                        Каталог проектов
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="/proizvodstvo" class="nav_logo_and_links_list_link">
                        Производство
                    </a>
                </li>
                <li>
                    <a href="/products" class="nav_logo_and_links_list_link">
                        Продукция
                    </a>
                </li>
                <li>
                    <a href="/stroitelniye_uslugi" class="nav_logo_and_links_list_link">
                        Услуги
                    </a>
                </li>
                <li>
                    <a href="/o_companii" class="nav_logo_and_links_list_link">
                        О нас
                    </a>
                </li>
            </ul>
        ...
        <section class="nav_connection">
            ...
            <p class="nav_connection_callback">Заказать обратный звонок</p>
            <button class="button_calculate_sidebar">Рассчитать проект</button>
        </section>
    </nav>
</div>