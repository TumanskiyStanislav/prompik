<section class="header_adaptive_component">
    <div class="header_adaptive_component_container">
        ...
        <div class="menu menu_active">
            ...
            <!-- <div> -->
                <ul class="nav_logo_and_links_list">
                    <li>
                        <a href="/catalog" class="header_logo_and_links_list_link">
                            Каталог проектов
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="/proizvodstvo" class="header_logo_and_links_list_link">
                            Производство
                        </a>
                    </li>
                    <li>
                        <a href="/products" class="header_logo_and_links_list_link">
                            Продукция
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="/o_companii" class="header_logo_and_links_list_link">
                            О нас
                        </a>
                    </li>
                </ul>
                <section class="nav_connection">
                    ...
                    <p class="header_connection_callback">Заказать обратный звонок</p>
                    <button class="button_calculate_header">Рассчитать проект</button>
                </section>
            <!-- </div> -->
        </div>
    </div>
